...
function Home() {
  ...
  return (
    <Container>
      ...
      <Section name="test1" className="element">
        ...
        <ContentWrapper>
          <Description>
            ...
            폰트로, 각진 세리프와 기하학적 형태감을 바탕으로 만들어졌다. 개발
            환경에서 주로 사용되는 모노스페이스 폰트는 영문 위주의 디자인이
            지배적이다. 개발을 하면서 한글을 타이핑하게 되는 순간은 많지 않지만,
            그 작은 순간들에서도 기본 폰트로 출력되는 한글이 나머지 영문
            텍스트들과 조화를 이루게 하고자 시도하게 되었다. Duru를 통해서
      ...
      <Section id="anchor" className="element">
        <Subtitle>
          사용
          <br />
          Usage
